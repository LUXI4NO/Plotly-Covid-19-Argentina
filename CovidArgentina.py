...
st.write("##")
with st.container():
    # Dividir el contenedor en tres columnas
...
with st.container():
    ...
    with tabla_column:
        ...
        fig = px.bar(
            ...
            text='Casos',  # Agregar el valor de los casos como texto en las barras
        )
        ...
        fig.update_traces(
            ...
            texttemplate='%{y:,.0f}',  # Agregar esta línea para aplicar el formato {:,.0f}
            marker_color='#6633FF', 
    ...
    with text_column :
        ...
        fig = px.bar(
            ...
            text='Muertes',  # Agregar el valor de los casos como texto en las barras
        )
...
with st.container():       
    ...
    fig.update_layout(
        ...
        title_font=dict(size=20, color='black'),  # Aumentar el tamaño del título
    ...
    fig.update_traces(
        ...
        hoverinfo='y+y',  # Información en el hover
    )
